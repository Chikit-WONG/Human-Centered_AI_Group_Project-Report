...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_ablation.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.92\linewidth]{figures/fig_hparam_confirmation.png}
...
\textbf{Chi Kit Wong}: overall brain--image co-adaptive framework and synchronized joint optimization with asymmetric learning rates. \textbf{Sida Zhang}: session-aware offline decoding as weighted bipartite matching and Hungarian/Sinkhorn analysis. \textbf{Zhiyi Chen}: lightweight residual-MLP EEG representation module and hyperparameter analysis. \textbf{Ziyi Guo}: CLIP/LoRA image adaptation and its conservative image-side learning rate. All members contributed equally to report writing, result interpretation, revision, and presentation preparation.
